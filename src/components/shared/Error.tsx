...
const Error:FC<ErrorInterface> = ({message}) => {
    return (
        <div className="animate__animated animate__fadeIn flex items-start gap-3 p-4 rounded-2xl bg-red-50 text-red-800 border border-red-200 shadow-sm max-w-full mt-7">
